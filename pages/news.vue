<template>
    <v-container>
        <v-row>
            <v-col>
                <span class="text-4xl text-bold text-red-500">{{ displayText.join("") }}</span>
            </v-col>
        </v-row>
    </v-container>
</template>
...
export default {
    ...
    computed: {
        ...
        timeoutSpeed: { get() { return this.currentSpeed / 1.2 }, set(v) { this.currentSpeed = v } },
